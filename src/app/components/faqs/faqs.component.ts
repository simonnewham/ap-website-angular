  ...
  questions: Faq[] = [
    ...
    },
    {
      ...
      Answer: `A consultation typically takes about 45 minutes. In this time I gather a general medical history and specific gynaecological history focusing on your concerns. An ultrasound scan is always done to compliment the physical examination. A Pap smear and urine analysis are done as appropriate.
         This costs R1200.00. The laboratory that processes your Pap smear will send an additional bill (about R290.00).`
    },
    {
      Question: 'What is a follow up visit and what does that cost?',
      Answer: `Sometimes you may need to return to assess the progress of a condition, the results of treatment or additional investigation. This is typically a 20 to 30 minute visit and will cost R600.00`
    },
    {
      ...
      Answer: `Special investigations with Pathologists/Radiologists are common. Here is a list of some you may one day need.
       These are approximations of coarse but we can give you an exact quote on the day, before requesting the investigation.
        ...
        Pap Smear: R290.00
        13 week Fetal scan: R2200.00 (outsourced to Fetal assessment centre)
        20 week Fetal scan: R2600.00 (outsourced to Fetal assessment centre)
        Insertion of Intra-uterine Contraceptive Device: R800.00
        Endometrial biopsy: R800.00

        Hormone levels via Pathcare:
        - Thyroid R385.00
        - Estrogen R245.00
        - Insulin Resistance 315.00
        - Testosterone R485.00`
    },
    {
